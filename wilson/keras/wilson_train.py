...
ID = "{}_{}_{}_{}_{}_{}_{}".format("MaxPoolDense256relu",DATASET_NAME,
...
def load_model():
    ...
    # Base layers
    x = Convolution2D(32, 3, 3, subsample=(2, 2), border_mode='valid', dim_ordering='tf')(base_out)
    x = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), border_mode='valid', dim_ordering='tf')(x)
    x = Flatten()(x)
...
def main():
    ...
    description = """Inception V3 with convolution and maxpooling layers with relu
                    activation"""
